# Generated by Powerlevel10k configuration wizard on 2026-06-11 at 20:55 PDT.
...
# angled separators, sharp heads, slanted tails, 2 lines, disconnected, full frame,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Always show local branch name in full without truncation.
